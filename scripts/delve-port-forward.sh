...
ctrlr_pf_pid=$(pgrep -fx "kubectl port-forward -n hub-agent svc/hub-agent-controller 40000:40000")
authsrvr_pf_pid=$(pgrep -fx "kubectl port-forward -n hub-agent svc/hub-agent-auth-server 39999:40000")
