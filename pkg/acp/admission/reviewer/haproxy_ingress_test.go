...
func TestHAProxyIngress_CanReviewChecksKind(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.desc, func(t *testing.T) {
			...
			review := NewHAProxyIngress("", i, policyGetterMock(policies))
...
func TestHAProxyIngress_HandleACPName(t *testing.T) {
	factory := func(policies PolicyGetter) reviewer {
		return NewHAProxyIngress("", ingressClassesMock{}, policies)
	}
...
func TestHAProxyIngress_Review(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.desc, func(t *testing.T) {
			...
			rev := NewHAProxyIngress("http://hub-agent.default.svc.cluster.local", ingressClassesMock{}, policyGetterMock(policies))
