...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccessControlPolicyDigestAuth) DeepCopyInto(out *AccessControlPolicyDigestAuth) {
	*out = *in
	if in.Users != nil {
		in, out := &in.Users, &out.Users
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessControlPolicyDigestAuth.
func (in *AccessControlPolicyDigestAuth) DeepCopy() *AccessControlPolicyDigestAuth {
	if in == nil {
		return nil
	}
	out := new(AccessControlPolicyDigestAuth)
	in.DeepCopyInto(out)
	return out
}
