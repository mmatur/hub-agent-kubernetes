...
import (
	...
	versioned "github.com/traefik/neo-agent/pkg/crd/generated/client/neo/clientset/versioned"
	internalinterfaces "github.com/traefik/neo-agent/pkg/crd/generated/client/neo/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/traefik/neo-agent/pkg/crd/generated/client/neo/listers/neo/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NeoV1alpha1().IngressClasses().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NeoV1alpha1().IngressClasses().Watch(context.TODO(), options)
			},
		},
...
func (f *ingressClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&neov1alpha1.IngressClass{}, f.defaultInformer)
}
